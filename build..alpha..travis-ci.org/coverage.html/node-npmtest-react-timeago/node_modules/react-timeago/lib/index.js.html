...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-timeago/node_modules/react-timeago/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-timeago/node_modules/react-timeago/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">35.07% <small>(47 / 134)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">15.24% <small>(16 / 105)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-timeago/node_modules/react-timeago/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function TimeAgo() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, TimeAgo);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TimeAgo.__proto__ || Object.getPrototypeOf(TimeAgo)).call.apply(_ref, [this].concat(args))), _this), _this.isStillMounted = false, _this.tick = <span class="fstat-no" title="function not covered" >function (refresh) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (!_this.isStillMounted || !_this.props.live) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var then = new Date(_this.props.date).valueOf();</span>
<span class="cstat-no" title="statement not covered" >      if (Number.isNaN(then)) {</span>
<span class="cstat-no" title="statement not covered" >        console.warn('[react-timeago] Invalid Date provided');</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var now = Date.now();</span>
<span class="cstat-no" title="statement not covered" >      var seconds = Math.round(Math.abs(now - then) / 1000);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var unboundPeriod = seconds &lt; MINUTE ? 1000 : seconds &lt; HOUR ? 1000 * MINUTE : seconds &lt; DAY ? 1000 * HOUR : 0;</span>
<span class="cstat-no" title="statement not covered" >      var period = Math.min(Math.max(unboundPeriod, _this.props.minPeriod * 1000), _this.props.maxPeriod * 1000);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (period) {</span>
<span class="cstat-no" title="statement not covered" >        _this.timeoutId = setTimeout(_this.tick, period);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!refresh) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.isStillMounted = true;</span>
<span class="cstat-no" title="statement not covered" >      if (this.props.live) {</span>
<span class="cstat-no" title="statement not covered" >        this.tick(true);</span>
      }
    }
  }, {
    key: 'componentDidUpdate',
    value: <span class="fstat-no" title="function not covered" >function componentDidUpdate(lastProps) {</span>
<span class="cstat-no" title="statement not covered" >      if (this.props.live !== lastProps.live || this.props.date !== lastProps.date) {</span>
<span class="cstat-no" title="statement not covered" >        if (!this.props.live &amp;&amp; this.timeoutId) {</span>
<span class="cstat-no" title="statement not covered" >          clearTimeout(this.timeoutId);</span>
        }
...
<span class="cstat-no" title="statement not covered" >      this.isStillMounted = false;</span>
<span class="cstat-no" title="statement not covered" >      if (this.timeoutId) {</span>
<span class="cstat-no" title="statement not covered" >        clearTimeout(this.timeoutId);</span>
<span class="cstat-no" title="statement not covered" >        this.timeoutId = undefined;</span>
      }
    }
  }, {
    key: 'render',
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var then = new Date(date).valueOf();</span>
<span class="cstat-no" title="statement not covered" >      if (Number.isNaN(then)) {</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
      }
<span class="cstat-no" title="statement not covered" >      var now = Date.now();</span>
<span class="cstat-no" title="statement not covered" >      var seconds = Math.round(Math.abs(now - then) / 1000);</span>
<span class="cstat-no" title="statement not covered" >      var suffix = then &lt; now ? 'ago' : 'from now';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _ref2 = seconds &lt; MINUTE ? [Math.round(seconds), 'second'] : seconds &lt; HOUR ? [Math.round(seconds / MINUTE), 'minute'] : seconds &lt; DAY ? [Math.round(seconds / HOUR), 'hour'] : seconds &lt; WEEK ? [Math.round(seconds / DAY), 'day'] : seconds &lt; MONTH ? [Math.round(seconds / WEEK), 'week'] : seconds &lt; YEAR ? [Math.round(seconds / MONTH), 'month'] : [Math.round(seconds / YEAR), 'year'],</span>
          _ref3 = _slicedToArray(_ref2, 2),
          value = _ref3[0],
          unit = _ref3[1];
&nbsp;
<span class="cstat-no" title="statement not covered" >      var passDownTitle = typeof title === 'undefined' ? typeof date === 'string' ? date : new Date(date).toISOString().substr(0, 16).replace('T', ' ') : title;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (Komponent === 'time') {</span>
<span class="cstat-no" title="statement not covered" >        passDownProps.dateTime = new Date(date).toISOString();</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var nextFormatter = _defaultFormatter2.default.bind(null, value, unit, suffix, then);</span>
&nbsp;
